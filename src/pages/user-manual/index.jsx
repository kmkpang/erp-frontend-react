                            ...
                            <div className="row g-4">
                                ...
                                <div className="col-12">
                                    <div className="card border bg-light shadow-sm rounded-4 p-4">
                                       ...
                                       <ul className="text-muted small ps-3 mb-0">
                                           <li className="mb-2"><strong>การสร้าง:</strong> สร้างขึ้นใหม่โดยเลือก รายการสินค้า ที่สอดคล้องจากระบบและกรอกรายละเอียดลูกค้า</li>
                                           <li className="mb-2 text-primary"> ใบเสนอราคาที่สร้างเสร็จแล้ว จะถูกเซฟเข้าระบบ <strong>สามารถนำข้อมูลไปสร้าง "ใบแจ้งหนี้" หรือ "ใบเสร็จรับเงิน" ได้ต่อทันที</strong> ทำให้ไม่ต้องกรอกข้อมูลอะไรใหม่ทั้งหมด</li>
                                       </ul>
                                    </div>
                                </div>
                                ...
                                <div className="col-12">
                                    <div className="card border bg-light shadow-sm rounded-4 p-4">
                                       ...
                                       <ul className="text-muted small ps-3 mb-0">
                                           ...
                                           <li className="mb-2 text-warning text-darken-2"> เมื่อส่งให้ลูกค้าและลูกค้าชำระเงินเรียบร้อยแล้ว สามารถออก <strong>ใบเสร็จรับเงิน/ใบกำกับภาษี</strong> (Billing Note) จากใบแจ้งหนี้ได้ทันที</li>
                                       </ul>
                                    </div>
                                ...
                                <div className="col-12">
                                    <div className="card border bg-light shadow-sm rounded-4 p-4">
                                       ...
                                       <ul className="text-muted small ps-3 mb-0">
                                           <li className="mb-2"><strong>การสร้าง:</strong> สร้างแยกเองได้อิสระ หรือ <strong>ดึงข้อมูลโดยตรงจาก "ใบเสนอราคา" หรือ "ใบแจ้งหนี้"</strong> ที่ทำไว้ก่อนหน้าได้เลย</li>
                                       </ul>
                                    </div>
                                </div>
                            </div>
